...
Public Class StockTransHistorySum
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "StockTransHistorySum.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Cupid.StockTransHistorySum.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedStockTransHistorySum
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As StockTransHistorySum = New StockTransHistorySum()
        rpt.Site = Me.Site
        Return rpt
    End Function
