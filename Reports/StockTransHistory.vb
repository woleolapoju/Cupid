...
Public Class StockTransHistory
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Cupid.StockTransHistory.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedStockTransHistory
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As StockTransHistory = New StockTransHistory()
        rpt.Site = Me.Site
        Return rpt
    End Function
