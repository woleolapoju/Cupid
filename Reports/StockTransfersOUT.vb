...
Public Class StockTransfersOUT
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Cupid.StockTransfersOUT.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedStockTransfersOUT
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As StockTransfersOUT = New StockTransfersOUT()
        rpt.Site = Me.Site
        Return rpt
    End Function
