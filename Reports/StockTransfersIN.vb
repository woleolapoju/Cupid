...
Public Class StockTransfersIN
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Cupid.StockTransfersIN.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedStockTransfersIN
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As StockTransfersIN = New StockTransfersIN()
        rpt.Site = Me.Site
        Return rpt
    End Function
