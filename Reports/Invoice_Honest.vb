...
Public Class Invoice_Honest
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Cupid.Invoice_Honest.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedInvoice_Honest
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Invoice_Honest = New Invoice_Honest()
        rpt.Site = Me.Site
        Return rpt
    End Function
