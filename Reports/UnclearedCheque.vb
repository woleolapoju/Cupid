...
Public Class UnclearedCheque
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Cupid.UnclearedCheque.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedUnclearedCheque
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As UnclearedCheque = New UnclearedCheque()
        rpt.Site = Me.Site
        Return rpt
    End Function
