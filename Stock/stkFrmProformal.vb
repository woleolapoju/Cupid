...
errhdl:
    ...
    Private Sub cmdAccept_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdAccept.Click
        ...
        Else
            ...
            DGridItems.Rows(j).Cells(4).Value = 0
...
errhdl:
    ...
    Private Sub cmdSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdSave.Click
        ...
        Dim filename As String = AppPath & "ConfigDir\" + "PInvoiceTemp.xls" 'Path.GetTempFileName()
        On Error Resume Next
        Kill(filename)

        FileCopy(AppPath & "ConfigDir\" + "PInvoice.xls", filename)
        ...
        oExcel.Cells(1, 2) = UCase(sysOwner)
        oExcel.Cells(2, 2) = Address
        oExcel.Cells(3, 4) = Phone
        oExcel.Cells(6, 7) = dtpDate.Text

        Dim j As Integer = 10
        For i = 0 To DGridItems.RowCount - 1
            oExcel.Cells(j, 2) = i + 1
            oExcel.Cells(j, 3) = DGridItems.Item(1, i).value
            oExcel.Cells(j, 4) = DGridItems.Item(2, i).value
            oExcel.Cells(j, 5) = DGridItems.Item(3, i).value
            oExcel.Cells(j, 6) = DGridItems.Item(4, i).value
            oExcel.Cells(j, 7) = DGridItems.Item(2, i).value * DGridItems.Item(3, i).value
            j = j + 1
        Next
...
errhdl:
    ...
    Private Sub lvProduct_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles lvProduct.KeyPress
