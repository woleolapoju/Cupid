...
Public Class stkFrmSales2
    ...
    Private Sub stkFrmSales1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Me.Load
        AppHeader1.lblForm.Text = "Sales"
        Me.BackColor = MainTheme
        ftbl.BackColor = MainTheme
        ...
        PanPrinter.Left = 42 'tblMain.Left + tblDetails.Left + PanPayment.Left + lnkPortPrinter.Left + 205
        ...
        AddHandler cmd0.Click, AddressOf btnClick1
        AddHandler cmd1.Click, AddressOf btnClick1
        AddHandler cmd2.Click, AddressOf btnClick1
        AddHandler cmd3.Click, AddressOf btnClick1
        AddHandler cmd4.Click, AddressOf btnClick1
        AddHandler cmd5.Click, AddressOf btnClick1
        AddHandler cmd6.Click, AddressOf btnClick1
        AddHandler cmd7.Click, AddressOf btnClick1
        AddHandler cmd8.Click, AddressOf btnClick1
        AddHandler cmd9.Click, AddressOf btnClick1
...
errhdl:
    ...
    Private Sub oLoadProduct(ByVal TheCat As String)
        ...
        drSQL = cmSQL.ExecuteReader()
        Do While drSQL.Read
            AddNewButton(drSQL.Item("ProductName").ToString, drSQL.Item("ProductCode").ToString, drSQL.Item("Qty"), drSQL.Item("TransType"))
        Loop
...
errhdl:
    ...
    Sub AddNewButton(ByVal strtxt As String, ByVal strCode As String, ByVal TheQty As Integer, ByVal TheTransType As String)
        Dim newButton As New Button
        On Error Resume Next
        Dim ImageName As String = StkFrmItemRegister.FindStockItemImageFilename(strCode)

        'PictStockImage.Visible = False
        PictStockImage.BackgroundImage = Nothing
        PictStockImage.BackgroundImage = Image.FromFile(ImageName)
        '  If PictStockImage.BackgroundImage Is Nothing Then Exit Sub
        'PictStockImage.Visible = True

        If TheTransType = "Retail" Then strtxt = strtxt + Chr(13) + "(" + Trim(Str(TheQty)) + ")"
        newButton.Text = strtxt
        ' Me.Button1.Location = New System.Drawing.Point(3, 3)
        ' Me.Button1.Name = "Button1"
        newButton.Size = New System.Drawing.Size(78, 71)
        newButton.UseVisualStyleBackColor = True
        newButton.Tag = strCode
        newButton.Cursor = Cursors.Hand

        If PictStockImage.BackgroundImage Is Nothing Then
        Else
            newButton.Image = Image.FromFile(ImageName)
        End If

        AddHandler newButton.Click, AddressOf btnClick
        Me.ftbl.Controls.Add(newButton)
    End Sub
    Private Sub btnClick(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Dim ClickedButton As Button = DirectCast(sender, Button)
        On Error Resume Next
        chkProduct = False
        GetProductByCode(ClickedButton.Tag)
        chkProduct = True
...
handler:
    ...
    Private Sub cCategory_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cCategory.SelectedIndexChanged
        On Error Resume Next
        tCategoryName.Tag = cCategory.Text
        tCategoryName.Text = cCategory.Text
        oLoadProduct(cCategory.Text)
    End Sub
    ...
    Private Sub stkFrmSales2_Resize(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Resize
        Me.Height = 653
        Me.Width = 1068
...
handler:
        MsgBox(Err.Description, vbInformation, strApptitle)
    End Sub
    Private Sub lnkAdditional_LinkClicked(ByVal sender As System.Object, ByVal e As System.Windows.Forms.LinkLabelLinkClickedEventArgs) Handles lnkAdditional.LinkClicked
        If lnkAdditional.Text = "Show Additional Quantity" Then
            FlowLayoutPanel1.Visible = True
            lnkAdditional.Text = "Hide Additional Quantity"
        Else
            FlowLayoutPanel1.Visible = False
            lnkAdditional.Text = "Show Additional Quantity"
        End If
    End Sub

    Private Sub btnClick1(ByVal sender As System.Object, ByVal e As System.EventArgs) 'Handles cmd1.Click
        On Error Resume Next
        If lvSalesList.Items.Count > 0 Then
            Dim ClickedButton As Button = DirectCast(sender, Button)
            Dim j As Integer = lvSalesList.Items.Count - 1
            lvSalesList.Items(j).Selected = True
            CmdOpen_Click(sender, e)
            PanList.Visible = False
            tQty.Text = Val(tQty.Text) + ClickedButton.Text
            cmdAccept_Click(sender, e)
        End If
