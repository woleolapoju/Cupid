...
Public Class StkFrmSalesPerson
    ...
    Private Sub FrmBaseUnit_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        AppHeader1.lblForm.Text = "Sales Person Setup"
        cmdOk.Enabled = ModuleOpen
        cmdRefresh.Enabled = ModuleOpen
        cmdNew.Enabled = ModuleOpen
        If ModuleOpen = False Then Exit Sub
        Me.DbGrid.DataSource = bindingSource1
        DbGrid.AutoGenerateColumns = False
        GetData("SELECT TheName FROM SALESPERSON")
    End Sub
...
handler:
    ...
    Private Sub cmdNew_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdNew.Click
        If Not DbGrid.IsCurrentCellInEditMode Then
            DbGrid.CurrentCell = DbGrid.Rows(DbGrid.Rows.Count - 1).Cells("TheName")
        End If
