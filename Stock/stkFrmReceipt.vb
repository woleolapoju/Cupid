...
Public Class stkFrmReceipt
    ...
    Private Sub stkFrmProformal_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        AppHeader1.lblForm.Text = "Restock"
...
errhdl:
    ...
    Private Sub cmdSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdSave.Click
        ...
        If Trim(tPaid.Text) = "" Then tPaid.Text = 0
        ...
        If lvSalesList.Items.Count > 0 Then
            ...
            For i = 0 To lvSalesList.Items.Count - 1
                If TheStore Like "*" & lvSalesList.Items(i).SubItems(10).Text & "*" Then GoTo skipit
                TheStore = TheStore + IIf(TheStore = "", "", ",") + lvSalesList.Items(i).SubItems(10).Text
SkipIt:
            Next i
            ...
            cmSQL.Parameters.AddWithValue("@ReceiptStore", TheStore)
            cmSQL.ExecuteNonQuery()
            ...
            For i = 0 To lvSalesList.Items.Count - 1
                ...
                cmSQL.Parameters.AddWithValue("@CostPrice", CDbl(lvSalesList.Items(i).SubItems(5).Text))
                ...
                cmSQL.Parameters.AddWithValue("@TransType", lvSalesList.Items(i).SubItems(11).Text)
...
errhdl:
    ...
    Private Sub cmdAccept_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdAccept.Click
        ...
        '    lvSalesList.Items(PositionInList).SubItems(5).Text = IIf((Val(lvSalesList.Items(PositionInList).SubItems(5).Text) + CDbl(tCostPrice.Text)) = 0, 0, Math.Round(CDbl(lvSalesList.Items(PositionInList).SubItems(5).Text) + CDbl(tCostPrice.Text)) / 2)
...
handler:
    ...
    Private Sub CmdOpen_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CmdOpen.Click
        ...
        tCostPrice.Text = Math.Round(CDbl(lvSalesList.SelectedItems(0).SubItems(5).Text), 2)
        tSellPrice.Text = Math.Round(CDbl(lvSalesList.SelectedItems(0).SubItems(7).Text), 2)
...
errhdl:
    ...
    Private Sub GetProductDetails(ByVal ProductCode As String)
        ...
        cmSQL.CommandText = "FetchActiveStoreItemsPerPerStore4Retail"
        cmSQL.Parameters.AddWithValue("@ProductCode", ProductCode)
        cmSQL.Parameters.AddWithValue("@Store", cStore.Text)
        cmSQL.CommandType = CommandType.StoredProcedure
        ''cnSQL.Open()
